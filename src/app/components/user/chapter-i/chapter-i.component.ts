...
// Función principal.
  void main()
  {
    ...
    system("pause");
        ...
        tabla3:'Tabla 1.1.3. ',
        linea1ej2:`printf("Hola mundo.\\n");`,
        linea2ej2:`printf("Bienvenidos al Lenguaje C/C++.\\n");`,
        linea3ej2:`system("pause");`,
...
// Incorporar una pausa en el programa.
`,
        linea1ej3:`cout << "Hola mundo" << endl; `,
        linea2ej3:`co  ut <     < "Hola mundo"  <     < en  dl;`,
        linea3ej3:`printf("Hola mundo.\\n"); `,
        linea4ej3:`pr  in   tf("Hola mundo.\\n");`,
      ...
      { label: 'Caso 1.2',
        ...
        linea1ej1:`#include <iostream>
#include <cstdlib>`,
        linea2ej1:`#include <stdio.h>
#include <cstdlib>`,
        code1:`"Hola mundo" << endl; `,
        code2:`// Definir una macro para imprimir un mensaje de Hola mundo.
...
#define INCORPORARPAUSA system("pause");
...
`,  tablaDatos9: [
          {Objeto:'',Propiedad:['%c'],Valor:['Formato de carácter a cadena de caracteres (string)']},
          {Objeto:'',Propiedad:['%d'],Valor:['Formato de entero a cadena de caracteres ']},
          {Objeto:'',Propiedad:['%ld'],Valor:['Formato de entero largo a cadena de caracteres ']},
          {Objeto:'',Propiedad:['%f'],Valor:['Formato de punto flotante a cadena de caracteres']},
          {Objeto:'',Propiedad:['%lf'],Valor:['Formato de punto flotante de doble precisión a cadena de caracteres']},
          {Objeto:'',Propiedad:['%s'],Valor:['Formato de cadena de caracteres a cadena de caracteres']},
          {Objeto:'',Propiedad:['%p'],Valor:['Formato de puntero a cadena de caracteres']},
        ],
        tablaDatos10: [
          {Objeto:'',Propiedad:['\n'],Valor:['Caracter de nueva línea: Representa a una nueva línea (intro).']},
          {Objeto:'',Propiedad:['\t'],Valor:['Caracter de tabulación: Representa a una tabulación (tab space).']},
          {Objeto:'',Propiedad:['\a'],Valor:['Caracter de alerta: Representa a una alerte.']},
          {Objeto:'',Propiedad:['\\'],Valor:['Backslash: Representa a un caracter de backslash.']},
          {Objeto:'',Propiedad:['\’'],Valor:['Símbolo de comilla simple.']},
          {Objeto:'',Propiedad:['\”'],Valor:['Símbolo de comillas dobles.']},
        ],
        tablaDatos11:`/*******************************************************
...
void main()
{
	...
	printf("\"Encerrar texto entre comillas dobles\"\n");
...
`,
        linea1ej2:`cout << "Ingrese su primer nombre y presione INTRO: ";`,
        linea2ej2:`cin >> primerNombre;`,
        linea3ej2:`cout << "Hola, " << primerNombre << endl;`,
        linea1ej3:`printf("Ingrese una letra: ");`,
        linea2ej3:`scanf_s("%c", &letra);`,
        linea3ej3:`printf("La letra ingresada fue: %c\\n", letra);`,
        code3:`int printf(const char *formato [, argumentos, …]);`,
        code4:`cout << "Hola, " << primerNombre << endl;`,
        code5:`int scanf(const char *formato [, direcciones, …]);`,
        implementacion1: '',
        implementacion2: '',
        imagen4: '',
        figuraNum4: '',
        ...
        tabladetalle1:'Objetos y sus Propiedades. ',
        tablaDatos1: [
          {Objeto:'',Propiedad:['#include <iostream>'],Valor:['Librería de Entrada y Salida de Flujo de Datos (Input/Output Stream). Esta librería es un componente de la biblioteca estándar (STL) del lenguaje de programación C++ que es utilizado para operaciones de entrada y salida. ']},
          {Objeto:'',Propiedad:['#include <stdio.h>'],Valor:['Librería de Encabezado Estándar de Entrada y Salida (Standard Input & Output Library Header). Esta librería tiene funciones para imprimir (output) y leer datos (input) desde la ventana de la consola. ']},
          {Objeto:'',Propiedad:['#include <cstdlib>'],Valor:['Librería de Utilidades Generales Estándar (C Standard General Utilities Library). Esta librería tiene funciones para gestión de memoria dinámica, generación de números aleatorios, comunicación con el ambiente, búsqueda de datos, ordenamiento de datos y control de pausas del sistema, entre otras.']},
          {Objeto:'',Propiedad:['#include <cmath>'],Valor:['Librería de Funciones Matemáticas (C Math Library). Esta librería tiene funciones para realizar operaciones matemáticas básicas, tales como: seno(), coseno(), tangente(), etc.']},
          {Objeto:'',Propiedad:['#include <ctime>'],Valor:['Librería de Tiempo (C Time Library). Esta librería contiene funciones para manipular y formatear la fecha y hora del sistema.']},
      ...
      { label: 'Caso 1.3',
        code1: `cin >> primerNombre;`,
        code2: `cout << "Hola, " << primerNombre << endl;`,
        code3: `scanf_s("%c", &letra);`,
        code4: `printf("La letra ingresada fue: %c\\n", letra);`,
        code5: `char letra;
int num_entero;
float num_flotante;
`,
...
int main()
{
	...
	// Incorporar una pausa en el programa.
	system("pause");
} `,tipsProgramacion:[{tip:'El lenguaje C/C++ es case sensitive (letra sensitiva). Por ejemplo, las siguientes palabras: hola, Hola, HOLA, hola, aunque quieren decir lo mismo, es decir, son únicas, ellas difieren por la letra (mayúscula y minúscula).'},
        ],
      },
      { label: 'Caso 1.4',
         tablaDatos1:`/*******************************************************
...
`,
        ...
        tablaDatos3:[
          {Objeto:"x = x + y;",Propiedad:['Asigna el valor de x + y en la misma variable x.'],Valor:[`int x = 5;
int y = 7;
x = x + y; // x = 12
`]},
          {Objeto:'x = x - y;',Propiedad:['Asigna el valor de x - y en la misma variable x.'],Valor:['Librería de Encabezado Estándar de Entrada y Salida (Standard Input & Output Library Header). Esta librería tiene funciones para imprimir (output) y leer datos (input) desde la ventana de la consola. ']},
          {Objeto:'x = x * y;',Propiedad:['Asigna el valor de x * y en la misma variable x.'],Valor:['Librería de Utilidades Generales Estándar (C Standard General Utilities Library). Esta librería tiene funciones para gestión de memoria dinámica, generación de números aleatorios, comunicación con el ambiente, búsqueda de datos, ordenamiento de datos y control de pausas del sistema, entre otras.']},
          {Objeto:'x = x / y;',Propiedad:['Asigna el valor de x / y en la misma variable x.'],Valor:['Librería de Funciones Matemáticas (C Math Library). Esta librería tiene funciones para realizar operaciones matemáticas básicas, tales como: seno(), coseno(), tangente(), etc.']},
